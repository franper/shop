...
var confirmarEliminar = new Vue({
  ...
  methods: {
    desea_eliminar: function desea_eliminar(id) {
      this.urlEliminar = document.getElementById("urlBase").innerHTML + '/' + id; // alert(this.urlEliminar);
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/Laravel/shop/resources/js/app_admin.js */"./resources/js/app_admin.js");
